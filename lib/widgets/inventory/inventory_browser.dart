...
import 'package:simple_contact/widgets/inventory/path_inventory_tile.dart';

import '../../auxiliary.dart';
import '../../clients/inventory_client.dart';
import '../../models/inventory/resonite_directory.dart';
import '../../models/records/record.dart';
import '../default_error_widget.dart';
import 'object_inventory_tile.dart';
              ...
              child: RefreshIndicator(
                ...
                child: Builder(
                  builder: (context) {
                    ...
                    records.sort(
                      (Record a, Record b) => iClient.sortMode.sortFunction(a, b, reverse: iClient.sortReverse) as int Function(Record a, Record b)?,
                    );
                    final paths = records
                        .where((element) =>
                            ...
                            GridView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return PathInventoryTile(
                                  record: record,
                                  selected: iClient.isRecordSelected(record as Record),
                                  onLongPress: () async {
                                    iClient.toggleRecordSelected(record as Record);
                                  },
                                  onTap: iClient.isAnyRecordSelected
                                      ...
                                      : () async {
                                          try {
                                            await iClient.navigateTo(record as Record);
                                          } catch (e) {
                                            if (context.mounted) {
